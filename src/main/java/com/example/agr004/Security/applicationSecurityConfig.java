package com.example.agr004.Security;

import com.example.agr004.Auth.ApplicationUserService;
import com.example.agr004.JWT.filter;
import com.example.agr004.JWT.jwtTokenVerifier;
...
public class applicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .authorizeRequests()
                .antMatchers("/clients/sign_in","/produits/all").permitAll()
                .anyRequest()
                .authenticated();
    }
    @Override
